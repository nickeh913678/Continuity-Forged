...
public class ContinuityConfig {
  ...
  public static final ContinuityConfig INSTANCE =
      new ContinuityConfig(FMLPaths.CONFIGDIR.get().resolve("continuity.json").toFile());
  ...
  protected final Object2ObjectLinkedOpenHashMap<String, Option<?>> optionMap =
      new Object2ObjectLinkedOpenHashMap<>();
  protected final Map<String, Option<?>> optionMapView = Collections.unmodifiableMap(optionMap);

  public final Option.BooleanOption connectedTextures =
      addOption(new Option.BooleanOption("connected_textures", true));
  public final Option.BooleanOption emissiveTextures =
      addOption(new Option.BooleanOption("emissive_textures", true));
  public final Option.BooleanOption customBlockLayers =
      addOption(new Option.BooleanOption("custom_block_layers", true));
  public final Option.BooleanOption useManualCulling =
      addOption(new Option.BooleanOption("use_manual_culling", true));
  ...
  protected void fromJson(JsonElement json) throws JsonParseException {
    if (json.isJsonObject()) {
      ...
      ObjectBidirectionalIterator<Object2ObjectMap.Entry<String, Option<?>>> iterator =
          optionMap.object2ObjectEntrySet().fastIterator();
