...
public class RepeatCtmProperties extends BaseCtmProperties {
  ...
  protected void parseWidth() {
    ...
    if (widthStr == null) {
      ContinuityClient.LOGGER.error(
          "No 'width' value provided in file '" + resourceId + "' in pack '" + packId + "'");
      valid = false;
      return;
    }
  ...
  protected void parseHeight() {
    ...
    if (heightStr == null) {
      ContinuityClient.LOGGER.error(
          "No 'height' value provided in file '" + resourceId + "' in pack '" + packId + "'");
      valid = false;
      return;
    }
  ...
  protected void parseOrient() {
    OrientationMode orientationMode =
        PropertiesParsingHelper.parseOrientationMode(properties, "orient", resourceId, packId);
