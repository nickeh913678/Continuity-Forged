...
public class OverlayPropertiesSection {
  ...
  public OverlayPropertiesSection(
      Properties properties, ResourceLocation resourceId, String packId) {
  ...
  protected void parseLayer() {
    ...
    switch (layerStr1) {
      ...
      default -> ContinuityClient.LOGGER.warn(
          "Unknown 'layer' value '"
              + layerStr
              + " in file '"
              + resourceId
