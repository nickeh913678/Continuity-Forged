...
public class SimpleQuadProcessor implements QuadProcessor {
  ...
  public SimpleQuadProcessor(
      SpriteProvider spriteProvider, ProcessingPredicate processingPredicate) {
  ...
  public static ProcessingResult process(
      MutableQuadView quad, TextureAtlasSprite oldSprite, @Nullable TextureAtlasSprite newSprite) {
    if (newSprite == null) {
