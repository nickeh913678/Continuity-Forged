...
public abstract class AbstractQuadProcessor implements QuadProcessor {
  ...
  public AbstractQuadProcessor(
      TextureAtlasSprite[] sprites, ProcessingPredicate processingPredicate) {
  ...
  public ProcessingResult processQuad(
    ...
    return processQuadInner(
        quad, sprite, blockView, appearanceState, state, pos, randomSupplier, pass, context);
  }

  public abstract ProcessingResult processQuadInner(
      MutableQuadView quad,
      TextureAtlasSprite sprite,
      BlockAndTintGetter blockView,
      BlockState appearanceState,
