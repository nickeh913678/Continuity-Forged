...
public final class QuadProcessors {
  ...
  private static class BlockStateKeyCache {
    private final Reference2ReferenceOpenHashMap<BlockState, SpriteKeyCache> map =
  ...
  private static class SpriteKeyCache implements Function<TextureAtlasSprite, Slice> {
    private final Reference2ReferenceOpenHashMap<TextureAtlasSprite, Slice> map =
        new Reference2ReferenceOpenHashMap<>(4, Hash.FAST_LOAD_FACTOR);
    private final StampedLock lock = new StampedLock();
